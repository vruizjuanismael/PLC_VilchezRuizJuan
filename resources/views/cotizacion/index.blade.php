      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h5 class="m-0">Cotizaciones <button class="btn btn-primary" onclick="nuevo()"><i class="fas fa-file"></i> Nuevo</button> <a href=""
                class="btn btn-success"><i class="fas fa-file-csv"></i> CSV</a></h5>
          </div>
          <div class="card-body">
            <div>
              <form action="{{route('cotizacion.index')}}" method="get">
                ...
                <table class="table table-striped table-bordered table-hover table-sm">
                  <thead>
                    <tr>
                      ...
                      <th width="10%">ID Cotizacion</th>
                      <th width="10%">Cliente ID</th>
                      <th width="10%">Fecha Creacion</th>
                      <th width="10%">Producto - Servicio</th>
